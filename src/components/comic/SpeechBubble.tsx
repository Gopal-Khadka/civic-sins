...
export function SpeechBubble({
	...
	return (
		<div
			className={cn(
				"relative max-w-[18rem] rounded-xl border border-border bg-card px-4 py-2.5 text-center",
				"text-sm leading-snug font-medium text-foreground shadow-[var(--shadow-sm)]",
				// tail
